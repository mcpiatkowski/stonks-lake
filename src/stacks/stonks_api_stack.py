...
class StonksApiStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        api_role = iam.Role(
            self, "ApiGatewayRole", assumed_by=iam.AccountPrincipal(Aws.ACCOUNT_ID), role_name="sf-stonks-api-role"
        )

        lambda_fn = lambda_.Function(
            self,
            "ExternalFunctionLambda",
        ...
        api = apigateway.RestApi(
            ...
            deploy=True,
            deploy_options=apigateway.StageOptions(stage_name="sf-dev"),
        ...
        CfnOutput(self, "AwsRoleArn", value=api_role.role_arn)
